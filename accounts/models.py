...
class Publisher(models.Model):
    ...
    name = models.CharField(max_length=255, help_text="The publisher's name")
    # A ForeignKey to api.Dataset is impossible, because the two models are in different databases.
    spider = models.CharField(
        max_length=255, unique=True, help_text="The spider's name in Kingfisher Collect, like chile_compra_bulk"
    )
...
class Profile(models.Model):
    ...
    language = models.CharField(max_length=255, blank=True, help_text="The user's preferred language")
