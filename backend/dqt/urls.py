...
from .views import dataset_stats, dataset_level_stats, field_level_stats, resource_level_stats, \
    field_level_path_stats, resource_level_check_name_stats
...
urlpatterns = [
    ...
    path(
        'api/resource_level_check_name_stats/<dataset_id>/<check_name>',
        resource_level_check_name_stats,
        name='resource_level_check_name_stats'
    ),
