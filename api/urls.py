...
urlpatterns = [
    *router.urls,
    ...
    path("datasets/<int:pk>/field_level/<str:name>/failures/", views.FieldLevelFailures.as_view()),
    path("datasets/<int:pk>/compiled_release_level/<str:name>/", views.ResourceLevelDetail.as_view()),
    path("datasets/<int:pk>/compiled_release_level/<str:name>/failures/", views.ResourceLevelFailures.as_view()),
