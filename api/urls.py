...
urlpatterns = [
    *router.urls,
    ...
    path("datasets/<int:pk>/field_level/<str:name>/failed_ocids/", views.FieldLevelFailedOcids.as_view()),
    path("datasets/<int:pk>/compiled_release_level/<str:name>/", views.ResourceLevelDetail.as_view()),
    path(
        "datasets/<int:pk>/compiled_release_level/<str:name>/failed_ocids/",
        views.ResourceLevelFailedOcids.as_view(),
    ),
