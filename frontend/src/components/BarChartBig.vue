...
export default {
    ...
    mounted() {
        this.chartData.push([
            ...
            `${this.formatPercentage(this.check.meta.shares["0_1"])} (${this.formatNumber(this.check.meta.counts["0_1"])})`,
        ...
        this.chartData.push([
            ...
            `${this.formatPercentage(this.check.meta.shares["1_5"])} (${this.formatNumber(this.check.meta.counts["1_5"])})`,
            "",
        ]);
        this.chartData.push([
            this.$t("datasetLevel.charts.label_5_20"),
            this.check.meta.shares["5_20"],
            `${this.formatPercentage(this.check.meta.shares["5_20"])} (${this.formatNumber(this.check.meta.counts["5_20"])})`,
            "",
        ]);
        this.chartData.push([
            this.$t("datasetLevel.charts.label_20_50"),
            this.check.meta.shares["20_50"],
            `${this.formatPercentage(this.check.meta.shares["20_50"])} (${this.formatNumber(this.check.meta.counts["20_50"])})`,
            "",
        ]);
        this.chartData.push([
            this.$t("datasetLevel.charts.label_50_100"),
            this.check.meta.shares["50_100"],
            `${this.formatPercentage(this.check.meta.shares["50_100"])} (${this.formatNumber(this.check.meta.counts["50_100"])})`,
            "",
        ]);
    },
};
