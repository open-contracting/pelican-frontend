export const messages = {
  ...
  resourceLevel: {
    ...
    averageScore: {
      description: "{applicable} of {total} checks are applicable, with a pass rate of {average_score}, excluding n/a",
      undefined: "undefined",
  ...
  overview: {
    ...
    collection_metadata_tooltip: "The OCID prefix and package metadata are extracted from the first compiled release.",
    compiled_releases: {
  ...
  fieldDetail: {
    ...
    quality: {
      ...
      date_time: {
        ...
        description: "The value is a string, starts in YYYY-MM-DD format, isn't before 1990 and isn't after 2050.",
      },
      email: {
      ...
      language: {
        ...
        description: "The value is a string and is a two-letter, lowercase, ISO 639-1 code. (The codelist is open.)",
      },
    },
  },
  timeLevel: {
