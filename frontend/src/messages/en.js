export const messages = {
  ...
  datasetReport: {
    ...
    status: {
      ...
      serverError:
        "An unexpected error has occurred. Please contact the support so it can be resolved.",
      warning:
        "Some elements were not computed. Please check your template and dataset.",
    },
    link: "Link",
    reason: "Reason",
    ...
    reportNameTooltip:
      "<p>(optional) Name of the exported document in Google Docs</p>",
    reportLanguage: "Export language",
    reportLanguageTooltip:
      "<p>Language of the generated content in the exported document</p>",
    submit: "Export",
    errorReport: "Errors",
    warningList:
      "These checks were not calculated, and might yield empty sections in the template:",
    warningEnd: "",
  },
  ...
  preview: {
    ...
    cannotDisplay:
      "The JSON data cannot be previewed, because its large size (more than 3,000 lines) can cause some browsers to crash. You can download the JSON file directly, instead.",
    nonExisting:
      "The item was not found in the database. The original dataset might have been deleted.",
  },
  examples: {
    ...
    copyToClipboard: {
      ...
      failure:
        "The JSON data cannot be copied to clipboard, because its large size (more than 3,000 lines) is not suitable for clipboards. You can download the JSON file directly, instead.",
  ...
  datasetLevel: {
    ...
    unique: {
      ...
      tender_id: {
        ...
        description:
          "Each <code>tender.id</code> is unique across the collection.",
        description_long:
  ...
  field: {
    ...
    hidden: "{n} hidden",
    checkedFields:
      "Checks are not performed on fields in extensions or on additional fields.",
    filterDropdown: {
      all: "All",
