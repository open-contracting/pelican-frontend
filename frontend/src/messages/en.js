export const messages = {
    ...
    datasetFilter: {
        ...
        buyerNameRegexTooltip: "Standard SQL REGEX format",
        procuringEntityNameRegex: "Procuring entity name",
        procuringEntityNameRegexTooltip: "Standard SQL REGEX format",
    ...
    datasetLevel: {
        ...
        distribution: {
            tender_status: {
                ...
                description:
                    "Visualizes the distribution of <code>tender.status</code> values. The 'active' and 'complete' codes each occur in between 1% and 99% of cases.",
                description_long:
                    "<p>Visualizes the distribution of <code>tender.status</code> values. The 'active' and 'complete' codes each occur in between 1% and 99% of cases.</p><p>The test is skipped if the field is never present.</p>",
            },
            ...
            main_procurement_category: {
                ...
                description_long:
                    "<p>Visualizes the distribution of <code>tender.mainProcurementCategory</code> values. No code occurs in more than 95% of cases.</p><p>The test is skipped if the field is never present.</p>",
            },
            tender_procurement_method: {
                name: "Procurement method distribution",
                description:
                    "Visualizes the distribution of <code>tender.procurementMethod</code> values. The 'open' code occurs in between 1% and 99% of cases.",
                description_long:
                    "<p>Visualizes the distribution of <code>tender.procurementMethod</code> values. The 'open' code occurs in between 1% and 99% of cases.</p><p>The test is skipped if the field is never present.</p>",
            },
            ...
            awards_status: {
                ...
                description:
                    "Visualizes the distribution of <code>awards.status</code> values. The 'active' code occurs in between 1% and 99% of cases.",
                description_long:
                    "<p>Visualizes the distribution of <code>awards.status</code> values. The 'active' code occurs in between 1% and 99% of cases.</p><p>The test is skipped if the field is never present.</p>",
            },
            contracts_status: {
                name: "Contract status distribution",
                description:
                    "Visualizes the distribution of <code>tender.status</code> values. The 'active' and 'terminated' codes each occur in between 1% and 99% of cases.",
                description_long:
                    "<p>Visualizes the distribution of <code>tender.status</code> values. The 'active' and 'terminated' codes each occur in between 1% and 99% of cases.</p><p>The test is skipped if the field is never present.</p>",
            },
            milestone_status: {
                name: "Milestone status distribution",
                description:
                    "Visualizes the distribution of milestone <code>status</code> values. The 'met' code occurs in between 1% and 99% of cases.",
                description_long:
            ...
            milestone_type: {
                ...
                description_long:
                    "Visualizes the distribution of milestone <code>type</code> values. No test is performed. The milestone fields are: <ul><li><code>planning.milestones.type</code></li><li><code>tender.milestones.type</code></li><li><code>awards.milestones.type</code></li><li><code>contracts.implementation.milestones.type</code></li></ul>",
            },
            value_currency: {
                name: "Currency distribution",
                description:
                    "Visualizes the distribution of <code>currency</code> values. No test is performed.",
                description_long:
                    "Visualizes the distribution of <code>currency</code> values. No test is performed. The fields are: <ul><li><code>planning.budget.value.currency</code></li><li><code>tender.value.currency</code></li><li><code>tender.minValue.currency</code></li><li><code>awards.value.currency</code></li><li><code>contracts.value.currency</code></li><li><code>contracts.implementation.transactions.value.currency</code></li></ul>",
            },
    ...
    overview: {
        ...
        filtered: {
            title: "Filtered from",
            info:
                "This dataset has been filtered from previously calculated dataset.",
