export const messages = {
    ...
    datasetReport: {
        ...
        documentIdTooltip: "id or url of the main template on Google Drive",
        folderId: "Folder id",
        folderIdTooltip: "id or url of the folder for the final report on Google Drive",
        reportName: "Report name",
        reportNameTooltip: "(optional) name of the the final report on Google Drive",
        submit: "Submit",
    ...
    resourceLevel: {
        ...
        averageScore: {
            ...
            undefined: "undefined",
            tooltip: "The score is computed as the percentage of total successful check applications from total applications; excluding not available applications.",
        },
        coherent: {
